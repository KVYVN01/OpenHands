...
export enum I18nKey {
  ...
  LANDING$INTERNAL_AGENT_PLATFORM = "LANDING$INTERNAL_AGENT_PLATFORM",
  LANDING$SIGN_IN_SUBTITLE = "LANDING$SIGN_IN_SUBTITLE",
  LANDING$CREATE_ACCOUNT_SUBTITLE = "LANDING$CREATE_ACCOUNT_SUBTITLE",
  LANDING$TAB_SIGN_IN = "LANDING$TAB_SIGN_IN",
  LANDING$TAB_CREATE_ACCOUNT = "LANDING$TAB_CREATE_ACCOUNT",
  LANDING$FIELD_EMAIL = "LANDING$FIELD_EMAIL",
  LANDING$FIELD_PASSWORD = "LANDING$FIELD_PASSWORD",
  LANDING$FIELD_DISPLAY_NAME = "LANDING$FIELD_DISPLAY_NAME",
  LANDING$PASSWORD_HINT = "LANDING$PASSWORD_HINT",
  LANDING$ACTION_SIGN_IN = "LANDING$ACTION_SIGN_IN",
  LANDING$ACTION_CREATE_ACCOUNT = "LANDING$ACTION_CREATE_ACCOUNT",
  LANDING$BUSY = "LANDING$BUSY",
  LANDING$LOCAL_DEPLOYMENT_NOTICE = "LANDING$LOCAL_DEPLOYMENT_NOTICE",
}
